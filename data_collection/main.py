...
async def extract_players(
  ...
  player_names = [("nui" if player_tr.attrs['data-name'] == "Nul" else player_tr.attrs['data-name']) for player_tr in player_trs]
  ...
  for i in range(len(player_ids)):
    safe_player_id = "nui" if player_ids[i].lower() == "nul" else player_ids[i]
